# SuperSonic
CMPE 130 Project - Spring 2018 - Flight Search Application Using Dijkstra's Shortest Path Algorithm

//============================================================================
// Name        : SuperSonic.cpp
// Author      : Gerald Carlo Garcia
// Version     :
...
int minDistance(int dist[], bool sptSet[])
{
    ...
    int min = INT_MAX;
    int min_index = 0; // initialize the min value
    ...
    for (int v = 0; v <  numOfCities; v++)
    {
        ...
        {
            static_cast<void>(min = dist[v]), min_index = v;
        }
    }
    return min_index;
}
 ...
 */
void printmat(string cities[numOfCities], int matrix[numOfCities][numOfCities])
{
    cout << "    ";
...
int main()
{
    ...
    {
        cout << "--------------------------------------------------------------------" << endl;
        cout << "\t\tWELCOME TO SUPERSONIC - Flight Optimizer" << endl;
        cout << "--------------------------------------------------------------------" << endl;
        ...
        else if (optionChoice == 0)
        {
            ...
            cout << "\t\t Thank you for using SuperSonic! " << endl;
            cout << "--------------------------------------------------------------------" << endl;
            break;
            return 0;
        }
